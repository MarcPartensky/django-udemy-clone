...
if DEBUG:
    ...
    DATABASES = {
        "default": {
            ...
            "USER": os.environ[
                "DB_USER"
            ],  # Remplacez par votre nom d'utilisateur PostgreSQL
            "PASSWORD": os.environ["DB_PASSWORD"],  # Remplacez par votre mot de passe
            "HOST": os.environ["DB_HOST"],  # Ou l'adresse de votre serveur PostgreSQL
